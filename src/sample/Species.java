...
public class Species {
	...
	public Species(int n) {
		...
		switch(n) {
			...
			case 1:	color = Color.YELLOW;	awareness = 24;	cohesiveness = 0.3;	willtosteer = 1.2;	divisiveness = 40;	break;
			case 2:	color = Color.GREEN;		awareness = 48;	cohesiveness = 1.2;	willtosteer = 1.2;	divisiveness = 20;	break;
			case 3:	color = Color.BLACK;	awareness = 24;	cohesiveness = 1.2;	willtosteer = 1.2;	divisiveness = 20;	break;
			case 4:	color = Color.BLUE;			awareness = 48;	cohesiveness = 1.2;	willtosteer = 0.3;	divisiveness = 40;	break;
			case 5:	color = Color.PURPLE;	awareness = 24;	cohesiveness = 1.2;	willtosteer = 0.3;	divisiveness = 40;	break;
		}
	}
}
